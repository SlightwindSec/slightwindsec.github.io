---
title: Official Solution to the "lowExponent" Problem in NepCTF2021
date: 2021-07-20 00:23:48
math: true
...
> 非预期：在使用 CRT 合并成一个同余式之后，由于明文 $m$ 相对 $n$ 过于小，可以用 Sage 的`.small_roots`求解出根，这样就不需要自己规约了。
